...
#define OS_LOWEST_PRIO           30u   /* Defines the lowest priority that can be assigned ...         */
                                       /* ... MUST NEVER be higher than 254!                           */

#define OS_MAX_EVENTS             5u   /* Max. number of event control blocks in your application      */
